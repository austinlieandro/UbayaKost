...
class SaveKostViewModel(application: Application): AndroidViewModel(application) {
    val saveKostLD = MutableLiveData<ArrayList<Kost>>()
    val TAG ="VolleyTag"
    ...
    fun fetch() {
        ...
        val url = "http://10.0.2.2/ANMP/saveKost.php"
